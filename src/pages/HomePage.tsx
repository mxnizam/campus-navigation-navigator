...
const HomePage: React.FC = () => {
  ...
  const infoCards = [
    ...
    },
    {
      ...
      description: 'Find information about students, courses, academic resources, and campus activities.',
      icon: <Users size={24} />,
      onClick: () => alert('Student Information feature coming soon!')
    },
    {
      title: 'Faculty Information',
      description: 'Learn about faculty members, departments, research areas, and contact information.',
            ...
            <div className="container relative px-4 md:px-6 z-10">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: '200ms' }}>
                  ...
                  <Button 
                    className="bg-campus-700/20 backdrop-blur-sm text-white hover:bg-campus-700/30 border border-white/20 font-medium"
